...
<html>
    ...
    <body>
        ...
        <%  
                ...
                out.println("<table class='table' border=1><thead><tr><th scope='col'>Medico</th><th scope='col'>Especialidade</th>"
                + "</tr></thead>");
                while(rs.next())
                {
                out.println("<tbody><td>" + rs.getString(2) + "</td>");
                out.println("<td>" + rs.getString(3)+ "</td></tr></tbody>");  
                }
                 out.println("</table>");
                }
                catch(Exception e)
